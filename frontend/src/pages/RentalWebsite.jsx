              ...
              <ul className="space-y-2 pt-4">
                <li>
                  <button
                    ...
                    className="block w-full text-left py-3 px-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg font-medium transition-all duration-300 flex items-center"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          {!loading && properties.length === 0 && (
            <div className="text-center py-12">
              <div className="text-gray-400 text-lg">No properties available at the moment.</div>
            </div>
          )}
        </div>
      </section>
