  ...
  return (
    <div className="space-y-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-4">
        ...
        <h2 className="text-2xl font-bold text-sky-700">Admin Settings</h2>
      </div>
      <div className="bg-white rounded-2xl shadow p-6 flex flex-col gap-6">
        <div className="flex items-center gap-4">
          <User className="w-10 h-10 text-sky-400" />
          <div>
            <div className="font-bold text-lg text-sky-700">Admin</div>
            <div className="text-gray-500 text-sm">admin@rentalbuddy.com</div>
          </div>
        </div>
        <div>
          ...
          <label className="flex items-center gap-2 mb-2">
            <input type="checkbox" className="accent-sky-500" /> Allow Admin Tools Access
          </label>
        </div>
